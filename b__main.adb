...
package body ada_main is
   ...
   E127 : Short_Integer; pragma Import (Ada, E127, "ada__assertions_E");
   ...
   E123 : Short_Integer; pragma Import (Ada, E123, "channels__security_E");
   E133 : Short_Integer; pragma Import (Ada, E133, "gateway__auth_E");
   E147 : Short_Integer; pragma Import (Ada, E147, "gateway__provider__registry_E");
   E145 : Short_Integer; pragma Import (Ada, E145, "gateway__provider__credentials_E");
   E139 : Short_Integer; pragma Import (Ada, E139, "plugins__capabilities_E");
   E149 : Short_Integer; pragma Import (Ada, E149, "runtime__memory_E");
   E153 : Short_Integer; pragma Import (Ada, E153, "security__audit_E");
   E142 : Short_Integer; pragma Import (Ada, E142, "security__policy_E");
   E136 : Short_Integer; pragma Import (Ada, E136, "runtime__executor_E");
   E151 : Short_Integer; pragma Import (Ada, E151, "security__secrets_E");
   E130 : Short_Integer; pragma Import (Ada, E130, "core__agent_E");
...
--  BEGIN Object file/option list
   --   /workspace/channels.o
   --   /workspace/channels-security.o
   --   /workspace/core.o
   --   /workspace/gateway.o
   --   /workspace/gateway-auth.o
   --   /workspace/gateway-provider.o
   --   /workspace/gateway-provider-registry.o
   --   /workspace/gateway-provider-credentials.o
   --   /workspace/plugins.o
   --   /workspace/plugins-capabilities.o
   --   /workspace/runtime.o
   --   /workspace/runtime-memory.o
   --   /workspace/security.o
   --   /workspace/security-audit.o
   --   /workspace/security-policy.o
   --   /workspace/runtime-executor.o
   --   /workspace/security-secrets.o
   --   /workspace/core-agent.o
   --   /workspace/main.o
   --   -L/workspace/
   --   -L/workspace/
