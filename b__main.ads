...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#2097f180#;
   ...
   u00121 : constant Version_32 := 16#15b4c450#;
   pragma Export (C, u00121, "channelsS");
   u00122 : constant Version_32 := 16#e67564aa#;
   pragma Export (C, u00122, "channels__securityB");
   u00123 : constant Version_32 := 16#0ce1c5a4#;
   pragma Export (C, u00123, "channels__securityS");
   u00124 : constant Version_32 := 16#48433bbe#;
   pragma Export (C, u00124, "system__assertionsB");
   u00125 : constant Version_32 := 16#6f8b84a5#;
   pragma Export (C, u00125, "system__assertionsS");
   u00126 : constant Version_32 := 16#96728d28#;
   pragma Export (C, u00126, "ada__assertionsB");
   u00127 : constant Version_32 := 16#d1602bfd#;
   pragma Export (C, u00127, "ada__assertionsS");
   u00128 : constant Version_32 := 16#e89194c9#;
   pragma Export (C, u00128, "coreS");
   u00129 : constant Version_32 := 16#b0c1b6e3#;
   pragma Export (C, u00129, "core__agentB");
   u00130 : constant Version_32 := 16#6d5df913#;
   pragma Export (C, u00130, "core__agentS");
   u00131 : constant Version_32 := 16#4b607369#;
   pragma Export (C, u00131, "gatewayS");
   u00132 : constant Version_32 := 16#c868e45e#;
   pragma Export (C, u00132, "gateway__authB");
   u00133 : constant Version_32 := 16#af4e90c3#;
   pragma Export (C, u00133, "gateway__authS");
   u00134 : constant Version_32 := 16#f5447b9d#;
   pragma Export (C, u00134, "runtimeS");
   u00135 : constant Version_32 := 16#2415ffab#;
   pragma Export (C, u00135, "runtime__executorB");
   u00136 : constant Version_32 := 16#ec226c74#;
   pragma Export (C, u00136, "runtime__executorS");
   u00137 : constant Version_32 := 16#b1d1cb82#;
   pragma Export (C, u00137, "pluginsS");
   u00138 : constant Version_32 := 16#bf3e1653#;
   pragma Export (C, u00138, "plugins__capabilitiesB");
   u00139 : constant Version_32 := 16#6278b53f#;
   pragma Export (C, u00139, "plugins__capabilitiesS");
   u00140 : constant Version_32 := 16#85e3015a#;
   pragma Export (C, u00140, "securityS");
   u00141 : constant Version_32 := 16#63c6b899#;
   pragma Export (C, u00141, "security__policyB");
   u00142 : constant Version_32 := 16#e91606ea#;
   pragma Export (C, u00142, "security__policyS");
   u00143 : constant Version_32 := 16#f608e452#;
   pragma Export (C, u00143, "gateway__providerS");
   u00144 : constant Version_32 := 16#e8012abc#;
   pragma Export (C, u00144, "gateway__provider__credentialsB");
   u00145 : constant Version_32 := 16#cf31f9b5#;
   pragma Export (C, u00145, "gateway__provider__credentialsS");
   u00146 : constant Version_32 := 16#abd0a870#;
   pragma Export (C, u00146, "gateway__provider__registryB");
   u00147 : constant Version_32 := 16#388cdcc6#;
   pragma Export (C, u00147, "gateway__provider__registryS");
   u00148 : constant Version_32 := 16#8c561069#;
   pragma Export (C, u00148, "runtime__memoryB");
   u00149 : constant Version_32 := 16#6ed28113#;
   pragma Export (C, u00149, "runtime__memoryS");
   u00150 : constant Version_32 := 16#7197a688#;
   pragma Export (C, u00150, "security__secretsB");
   u00151 : constant Version_32 := 16#bd67003b#;
   pragma Export (C, u00151, "security__secretsS");
   u00152 : constant Version_32 := 16#b26e9487#;
   pragma Export (C, u00152, "security__auditB");
   u00153 : constant Version_32 := 16#3bcde460#;
   pragma Export (C, u00153, "security__auditS");
   u00154 : constant Version_32 := 16#eca5ecae#;
   pragma Export (C, u00154, "system__memoryB");
   u00155 : constant Version_32 := 16#fba7f029#;
