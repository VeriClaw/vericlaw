...
package Channels.Adapters.WhatsApp_Bridge with SPARK_Mode is
   ...
   function Inbound_Acceptance
     (Context : Security_Context) return Inbound_Result is
      (Inbound_Acceptance (Channel_Enabled => False, Context => Context));
   ...
   function Outbound_Eligibility
     ...
     (Channels.Adapters.Outbound_Eligibility
        (Channel         => Channels.Security.WhatsApp_Bridge_Channel,
         Channel_Enabled => Channel_Enabled,
         Context         => Context));
end Channels.Adapters.WhatsApp_Bridge;
