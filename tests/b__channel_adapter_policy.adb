pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b__channel_adapter_policy.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b__channel_adapter_policy.adb");
...
package body ada_main is
   ...
   E099 : Short_Integer; pragma Import (Ada, E099, "ada__assertions_E");
   E008 : Short_Integer; pragma Import (Ada, E008, "channels__security_E");
   E006 : Short_Integer; pragma Import (Ada, E006, "channels__adapters_E");
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_channel_adapter_policy");
...
--  BEGIN Object file/option list
   ...
   --   /workspace/tests/channels-adapters.o
   --   /workspace/tests/channels-adapters-discord.o
   --   /workspace/tests/channels-adapters-email.o
   --   /workspace/tests/channels-adapters-slack.o
   --   /workspace/tests/channels-adapters-telegram.o
   --   /workspace/tests/channels-adapters-whatsapp_bridge.o
   --   /workspace/tests/channel_adapter_policy.o
   --   -L/workspace/tests/
   --   -L/workspace/tests/
