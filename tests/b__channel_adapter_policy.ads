...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_channel_adapter_policy" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#38e04f9d#;
   pragma Export (C, u00001, "channel_adapter_policyB");
   ...
   u00005 : constant Version_32 := 16#2349db7e#;
   pragma Export (C, u00005, "channels__adaptersB");
   u00006 : constant Version_32 := 16#41bbd60b#;
   pragma Export (C, u00006, "channels__adaptersS");
   u00007 : constant Version_32 := 16#e67564aa#;
   pragma Export (C, u00007, "channels__securityB");
   u00008 : constant Version_32 := 16#0ce1c5a4#;
   pragma Export (C, u00008, "channels__securityS");
   u00009 : constant Version_32 := 16#48433bbe#;
   pragma Export (C, u00009, "system__assertionsB");
   u00010 : constant Version_32 := 16#6f8b84a5#;
   pragma Export (C, u00010, "system__assertionsS");
   u00011 : constant Version_32 := 16#76789da1#;
   pragma Export (C, u00011, "adaS");
   u00012 : constant Version_32 := 16#7a7a1ff8#;
   pragma Export (C, u00012, "ada__exceptionsB");
   u00013 : constant Version_32 := 16#661890aa#;
   pragma Export (C, u00013, "ada__exceptionsS");
   u00014 : constant Version_32 := 16#19b42e05#;
   pragma Export (C, u00014, "ada__exceptions__last_chance_handlerB");
   u00015 : constant Version_32 := 16#fc9377ef#;
   pragma Export (C, u00015, "ada__exceptions__last_chance_handlerS");
   u00016 : constant Version_32 := 16#a2da961d#;
   pragma Export (C, u00016, "systemS");
   u00017 : constant Version_32 := 16#adf22619#;
   pragma Export (C, u00017, "system__soft_linksB");
   u00018 : constant Version_32 := 16#ee9070f7#;
   pragma Export (C, u00018, "system__soft_linksS");
   u00019 : constant Version_32 := 16#6c2097a7#;
   pragma Export (C, u00019, "system__secondary_stackB");
   u00020 : constant Version_32 := 16#5371a199#;
   ...
   u00022 : constant Version_32 := 16#e58852d6#;
   ...
   u00028 : constant Version_32 := 16#2c65fdf5#;
   ...
   u00030 : constant Version_32 := 16#b1e67ab7#;
   pragma Export (C, u00030, "system__exception_tableS");
   u00031 : constant Version_32 := 16#fc140986#;
   ...
   u00033 : constant Version_32 := 16#59a6462e#;
   ...
   u00040 : constant Version_32 := 16#8472457c#;
   pragma Export (C, u00040, "system__traceback_entriesS");
   u00041 : constant Version_32 := 16#53898024#;
   pragma Export (C, u00041, "system__traceback__symbolicB");
   u00042 : constant Version_32 := 16#4f57b9be#;
   ...
   u00045 : constant Version_32 := 16#bba159a5#;
   pragma Export (C, u00045, "ada__exceptions__tracebackS");
   u00046 : constant Version_32 := 16#edec285f#;
   pragma Export (C, u00046, "interfacesS");
   u00047 : constant Version_32 := 16#fb01eaa4#;
   pragma Export (C, u00047, "interfaces__cB");
   u00048 : constant Version_32 := 16#7300324d#;
   ...
   u00091 : constant Version_32 := 16#b9a7b4cf#;
   pragma Export (C, u00091, "system__wch_conS");
   u00092 : constant Version_32 := 16#9721e840#;
   pragma Export (C, u00092, "system__wch_stwB");
   u00093 : constant Version_32 := 16#94b698ce#;
   pragma Export (C, u00093, "system__wch_stwS");
   u00094 : constant Version_32 := 16#1f681dab#;
   pragma Export (C, u00094, "system__wch_cnvB");
   u00095 : constant Version_32 := 16#b6100e3c#;
   pragma Export (C, u00095, "system__wch_cnvS");
   u00096 : constant Version_32 := 16#ece6fdb6#;
   pragma Export (C, u00096, "system__wch_jisB");
   u00097 : constant Version_32 := 16#3660171d#;
   pragma Export (C, u00097, "system__wch_jisS");
   u00098 : constant Version_32 := 16#96728d28#;
   pragma Export (C, u00098, "ada__assertionsB");
   u00099 : constant Version_32 := 16#d1602bfd#;
   pragma Export (C, u00099, "ada__assertionsS");
   u00100 : constant Version_32 := 16#fd3da448#;
   pragma Export (C, u00100, "channels__adapters__discordS");
   u00101 : constant Version_32 := 16#3cadb925#;
   pragma Export (C, u00101, "channels__adapters__emailS");
   u00102 : constant Version_32 := 16#0ab067b6#;
   pragma Export (C, u00102, "channels__adapters__slackS");
   u00103 : constant Version_32 := 16#7a9fb31e#;
   pragma Export (C, u00103, "channels__adapters__telegramS");
   u00104 : constant Version_32 := 16#4968dc91#;
   pragma Export (C, u00104, "channels__adapters__whatsapp_bridgeS");
   u00105 : constant Version_32 := 16#eca5ecae#;
   pragma Export (C, u00105, "system__memoryB");
   u00106 : constant Version_32 := 16#fba7f029#;
   ...
   --  channels.adapters%s
   --  channels.adapters%b
   --  channels.adapters.discord%s
   --  channels.adapters.email%s
   --  channels.adapters.slack%s
   --  channels.adapters.telegram%s
   --  channels.adapters.whatsapp_bridge%s
   --  channel_adapter_policy%b
