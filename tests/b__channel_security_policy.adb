pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b__channel_security_policy.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b__channel_security_policy.adb");
...
package body ada_main is
   ...
   E06 : Short_Integer; pragma Import (Ada, E06, "channels__security_E");
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_channel_security_policy");
...
--  BEGIN Object file/option list
   ...
   --   /workspace/tests/channel_security_policy.o
   --   -L/workspace/tests/
   --   -L/workspace/tests/
