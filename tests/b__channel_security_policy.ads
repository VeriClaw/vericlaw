...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_channel_security_policy" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#26c01de2#;
   pragma Export (C, u00001, "channel_security_policyB");
