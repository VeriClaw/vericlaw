...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_competitive_v2_security_regression_fuzz_suite" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#2a1f86d7#;
   pragma Export (C, u00001, "competitive_v2_security_regression_fuzz_suiteB");
   u00002 : constant Version_32 := 16#2e11c0b1#;
   pragma Export (C, u00002, "system__standard_libraryB");
   u00003 : constant Version_32 := 16#eb6e0dda#;
   pragma Export (C, u00003, "system__standard_libraryS");
   u00004 : constant Version_32 := 16#15b4c450#;
   pragma Export (C, u00004, "channelsS");
   u00005 : constant Version_32 := 16#e67564aa#;
   pragma Export (C, u00005, "channels__securityB");
   u00006 : constant Version_32 := 16#0ce1c5a4#;
   pragma Export (C, u00006, "channels__securityS");
   u00007 : constant Version_32 := 16#48433bbe#;
   pragma Export (C, u00007, "system__assertionsB");
   u00008 : constant Version_32 := 16#6f8b84a5#;
   ...
   u00020 : constant Version_32 := 16#e58852d6#;
   ...
   u00022 : constant Version_32 := 16#8f19dc19#;
   ...
   u00026 : constant Version_32 := 16#2c65fdf5#;
   ...
   u00038 : constant Version_32 := 16#8472457c#;
   pragma Export (C, u00038, "system__traceback_entriesS");
   u00039 : constant Version_32 := 16#53898024#;
   pragma Export (C, u00039, "system__traceback__symbolicB");
   u00040 : constant Version_32 := 16#4f57b9be#;
   ...
   u00043 : constant Version_32 := 16#bba159a5#;
   pragma Export (C, u00043, "ada__exceptions__tracebackS");
   u00044 : constant Version_32 := 16#edec285f#;
   pragma Export (C, u00044, "interfacesS");
   u00045 : constant Version_32 := 16#fb01eaa4#;
   pragma Export (C, u00045, "interfaces__cB");
   u00046 : constant Version_32 := 16#7300324d#;
   ...
   u00081 : constant Version_32 := 16#f0abf593#;
   ...
   u00096 : constant Version_32 := 16#96728d28#;
   pragma Export (C, u00096, "ada__assertionsB");
   u00097 : constant Version_32 := 16#d1602bfd#;
   pragma Export (C, u00097, "ada__assertionsS");
   u00098 : constant Version_32 := 16#4b607369#;
   pragma Export (C, u00098, "gatewayS");
   u00099 : constant Version_32 := 16#f608e452#;
   pragma Export (C, u00099, "gateway__providerS");
   u00100 : constant Version_32 := 16#e8012abc#;
   pragma Export (C, u00100, "gateway__provider__credentialsB");
   u00101 : constant Version_32 := 16#cf31f9b5#;
   pragma Export (C, u00101, "gateway__provider__credentialsS");
   u00102 : constant Version_32 := 16#abd0a870#;
   pragma Export (C, u00102, "gateway__provider__registryB");
   u00103 : constant Version_32 := 16#388cdcc6#;
   pragma Export (C, u00103, "gateway__provider__registryS");
   u00104 : constant Version_32 := 16#03f6f9f4#;
   pragma Export (C, u00104, "gateway__provider__routingB");
   u00105 : constant Version_32 := 16#ee3ac35d#;
   pragma Export (C, u00105, "gateway__provider__routingS");
   u00106 : constant Version_32 := 16#f5447b9d#;
   pragma Export (C, u00106, "runtimeS");
   u00107 : constant Version_32 := 16#2415ffab#;
   pragma Export (C, u00107, "runtime__executorB");
   u00108 : constant Version_32 := 16#ec226c74#;
   pragma Export (C, u00108, "runtime__executorS");
   u00109 : constant Version_32 := 16#b1d1cb82#;
   pragma Export (C, u00109, "pluginsS");
   u00110 : constant Version_32 := 16#bf3e1653#;
   pragma Export (C, u00110, "plugins__capabilitiesB");
   u00111 : constant Version_32 := 16#6278b53f#;
   pragma Export (C, u00111, "plugins__capabilitiesS");
   u00112 : constant Version_32 := 16#85e3015a#;
   pragma Export (C, u00112, "securityS");
   u00113 : constant Version_32 := 16#63c6b899#;
   pragma Export (C, u00113, "security__policyB");
   u00114 : constant Version_32 := 16#e91606ea#;
   pragma Export (C, u00114, "security__policyS");
   u00115 : constant Version_32 := 16#b26e9487#;
   pragma Export (C, u00115, "security__auditB");
   u00116 : constant Version_32 := 16#3bcde460#;
   pragma Export (C, u00116, "security__auditS");
   u00117 : constant Version_32 := 16#c8f8c90a#;
   pragma Export (C, u00117, "security__defaultsS");
   u00118 : constant Version_32 := 16#ac3a86ee#;
   pragma Export (C, u00118, "security__migrationB");
   u00119 : constant Version_32 := 16#c71afb32#;
   pragma Export (C, u00119, "security__migrationS");
   u00120 : constant Version_32 := 16#eca5ecae#;
   pragma Export (C, u00120, "system__memoryB");
   u00121 : constant Version_32 := 16#fba7f029#;
   ...
   --  gateway.provider.routing%s
   --  gateway.provider.routing%b
   --  plugins%s
   ...
   --  security.migration%b
   --  security.policy%s
   --  security.policy%b
   --  runtime.executor%s
   --  runtime.executor%b
   --  competitive_v2_security_regression_fuzz_suite%b
