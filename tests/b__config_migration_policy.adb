pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b__config_migration_policy.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b__config_migration_policy.adb");
...
package body ada_main is
   ...
   E007 : Short_Integer; pragma Import (Ada, E007, "security__migration_E");
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_config_migration_policy");
...
--  BEGIN Object file/option list
   ...
   --   /workspace/tests/config_migration_policy.o
   --   -L/workspace/tests/
   --   -L/workspace/tests/
