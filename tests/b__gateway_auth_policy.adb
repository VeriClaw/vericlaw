pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b__gateway_auth_policy.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b__gateway_auth_policy.adb");
...
package body ada_main is
   ...
   E06 : Short_Integer; pragma Import (Ada, E06, "gateway__auth_E");
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_gateway_auth_policy");
...
--  BEGIN Object file/option list
   ...
   --   /workspace/tests/gateway-auth.o
   --   /workspace/tests/gateway_auth_policy.o
   --   -L/workspace/tests/
   --   -L/workspace/tests/
