pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b__memory_backend_suite_policy.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b__memory_backend_suite_policy.adb");
...
package body ada_main is
   ...
   E06 : Short_Integer; pragma Import (Ada, E06, "runtime__memory_E");
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_memory_backend_suite_policy");
...
--  BEGIN Object file/option list
   ...
   --   /workspace/tests/runtime-memory.o
   --   /workspace/tests/memory_backend_suite_policy.o
   --   -L/workspace/tests/
   --   -L/workspace/tests/
