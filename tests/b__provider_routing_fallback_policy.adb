pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b__provider_routing_fallback_policy.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b__provider_routing_fallback_policy.adb");
...
package body ada_main is
   ...
   E102 : Short_Integer; pragma Import (Ada, E102, "gateway__provider__routing_E");
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_provider_routing_fallback_policy");
...
--  BEGIN Object file/option list
   ...
   --   /workspace/tests/provider_routing_fallback_policy.o
   --   -L/workspace/tests/
   --   -L/workspace/tests/
