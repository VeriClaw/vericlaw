...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_provider_routing_fallback_policy" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#e2751db0#;
   pragma Export (C, u00001, "provider_routing_fallback_policyB");
   ...
   u00101 : constant Version_32 := 16#03f6f9f4#;
   pragma Export (C, u00101, "gateway__provider__routingB");
   u00102 : constant Version_32 := 16#ee3ac35d#;
   pragma Export (C, u00102, "gateway__provider__routingS");
   u00103 : constant Version_32 := 16#eca5ecae#;
   pragma Export (C, u00103, "system__memoryB");
   u00104 : constant Version_32 := 16#fba7f029#;
   ...
   --  provider_routing_fallback_policy%b
