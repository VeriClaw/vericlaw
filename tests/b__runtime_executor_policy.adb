pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b__runtime_executor_policy.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b__runtime_executor_policy.adb");
...
package body ada_main is
   ...
   E100 : Short_Integer; pragma Import (Ada, E100, "plugins__capabilities_E");
   E106 : Short_Integer; pragma Import (Ada, E106, "security__policy_E");
   E103 : Short_Integer; pragma Import (Ada, E103, "runtime__executor_E");
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_runtime_executor_policy");
...
--  BEGIN Object file/option list
   ...
   --   /workspace/tests/runtime_executor_policy.o
   --   -L/workspace/tests/
   --   -L/workspace/tests/
