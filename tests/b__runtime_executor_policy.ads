...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_runtime_executor_policy" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#9fa95a8e#;
   pragma Export (C, u00001, "runtime_executor_policyB");
   ...
   u00098 : constant Version_32 := 16#b1d1cb82#;
   pragma Export (C, u00098, "pluginsS");
   u00099 : constant Version_32 := 16#bf3e1653#;
   pragma Export (C, u00099, "plugins__capabilitiesB");
   u00100 : constant Version_32 := 16#6278b53f#;
   pragma Export (C, u00100, "plugins__capabilitiesS");
   u00101 : constant Version_32 := 16#f5447b9d#;
   pragma Export (C, u00101, "runtimeS");
   u00102 : constant Version_32 := 16#2415ffab#;
   pragma Export (C, u00102, "runtime__executorB");
   u00103 : constant Version_32 := 16#ec226c74#;
   pragma Export (C, u00103, "runtime__executorS");
