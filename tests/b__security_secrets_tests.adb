pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b__security_secrets_tests.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b__security_secrets_tests.adb");
...
package body ada_main is
   ...
   E098 : Short_Integer; pragma Import (Ada, E098, "ada__assertions_E");
   E100 : Short_Integer; pragma Import (Ada, E100, "gateway__provider__registry_E");
   E007 : Short_Integer; pragma Import (Ada, E007, "gateway__provider__credentials_E");
   E103 : Short_Integer; pragma Import (Ada, E103, "security__audit_E");
   E105 : Short_Integer; pragma Import (Ada, E105, "security__policy_E");
   E107 : Short_Integer; pragma Import (Ada, E107, "security__secrets_E");
   E109 : Short_Integer; pragma Import (Ada, E109, "security__secrets__crypto_E");
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_security_secrets_tests");
...
--  BEGIN Object file/option list
   ...
   --   /workspace/tests/security-secrets.o
   --   /workspace/tests/security-secrets-crypto.o
   --   /workspace/tests/security_secrets_tests.o
   --   -L/workspace/tests/
   --   -L/workspace/tests/
