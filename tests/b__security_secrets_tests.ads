...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_security_secrets_tests" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#236ea0bd#;
   pragma Export (C, u00001, "security_secrets_testsB");
   ...
   u00005 : constant Version_32 := 16#f608e452#;
   pragma Export (C, u00005, "gateway__providerS");
   u00006 : constant Version_32 := 16#e8012abc#;
   pragma Export (C, u00006, "gateway__provider__credentialsB");
   u00007 : constant Version_32 := 16#cf31f9b5#;
   pragma Export (C, u00007, "gateway__provider__credentialsS");
   u00008 : constant Version_32 := 16#48433bbe#;
   pragma Export (C, u00008, "system__assertionsB");
   u00009 : constant Version_32 := 16#6f8b84a5#;
   pragma Export (C, u00009, "system__assertionsS");
   ...
   u00097 : constant Version_32 := 16#96728d28#;
   pragma Export (C, u00097, "ada__assertionsB");
   u00098 : constant Version_32 := 16#d1602bfd#;
   pragma Export (C, u00098, "ada__assertionsS");
   u00099 : constant Version_32 := 16#abd0a870#;
   pragma Export (C, u00099, "gateway__provider__registryB");
   u00100 : constant Version_32 := 16#388cdcc6#;
   pragma Export (C, u00100, "gateway__provider__registryS");
   u00101 : constant Version_32 := 16#85e3015a#;
   pragma Export (C, u00101, "securityS");
   u00102 : constant Version_32 := 16#b26e9487#;
   pragma Export (C, u00102, "security__auditB");
   u00103 : constant Version_32 := 16#3bcde460#;
   pragma Export (C, u00103, "security__auditS");
   u00104 : constant Version_32 := 16#63c6b899#;
   pragma Export (C, u00104, "security__policyB");
   u00105 : constant Version_32 := 16#e91606ea#;
   pragma Export (C, u00105, "security__policyS");
   u00106 : constant Version_32 := 16#7197a688#;
   pragma Export (C, u00106, "security__secretsB");
   u00107 : constant Version_32 := 16#bd67003b#;
   pragma Export (C, u00107, "security__secretsS");
   u00108 : constant Version_32 := 16#185ce507#;
   pragma Export (C, u00108, "security__secrets__cryptoB");
   u00109 : constant Version_32 := 16#13e55458#;
   pragma Export (C, u00109, "security__secrets__cryptoS");
   ...
   --  security.secrets%s
   --  security.secrets%b
   --  security.secrets.crypto%s
   --  security.secrets.crypto%b
   --  security_secrets_tests%b
